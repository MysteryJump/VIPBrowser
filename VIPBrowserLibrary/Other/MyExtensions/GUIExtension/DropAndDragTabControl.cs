...
{
    /// <summary>
    /// ドラッグアンドドロップ機能をサポートしたタブコントロールを提供します
    /// </summary>
    public class DropAndDragTabControl : TabControl
    {
        ...
        /// DragOverイベントを発生させます
        /// </summary>
        /// <param name="e">発生のイベントデータを収納したDragEventArgs</param>
        ...
        /// </summary>
        /// <param name="e">発生の元となるMouseEventArgs</param>
        ...
        /// </summary>
        /// <param name="e">発生の元となるEventArgs</param>
