...
namespace VIPBrowserLibrary.Other
{
    ...
    //        //"vipbrowser", "wL/9kxf9H+eesCzWUaAyx7SGnzOC5SGU5t379mMLl/Q="
    //        AdmAuthentication admAuth = new AdmAuthentication("vipbrowser", "wL/9kxf9H+eesCzWUaAyx7SGnzOC5SGU5t379mMLl/Q=");
    ...
    //        string uri = "http://api.microsofttranslator.com/v2/Http.svc/GetTranslations?text=" + "I love pen." + "&from=" + "en" + "&to=" + "ja" + "&maxTranslations=5";
    ...
    //        //    }
    //        //}
    //        HttpWebResponse wep = (HttpWebResponse)e.Response;
    //        Stream wepStr = wep.GetResponseStream();
    //        strResponse = new StreamReader(wepStr, Encoding.ASCII).ReadToEnd();
